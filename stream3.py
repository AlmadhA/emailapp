...
for feature in geojson_data['features']:  # Jika features ada, proses masing-masing
    province_name = feature['properties']['Propinsi'].strip().upper()
    ...
    if not matching_row.empty:
        ...
        # Jika provinsi tidak ditemukan di DataFrame, beri pesan
        folium.GeoJsonTooltip(
            fields=['Propinsi'],
            aliases=['Provinsi'],
            localize=True
